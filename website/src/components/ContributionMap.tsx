...
const strings = {
  en: {
    title: "The Prism Network is Growing",
    subtitle: "Contributors across Hungary are building civic intelligence together.",
    stats_contributors: "Active Contributors",
    stats_verifications: "Verifications",
    stats_reports: "Reports",
    stats_translations: "Translations",
    stats_flags: "Evidence Flags",
  ...
  hu: {
    title: "A Prism hálózat nő",
    subtitle:
      "Az egész Magyarország közösségi tagjai közösen építenek demokratikus értelmezést.",
    stats_contributors: "Aktív közreműködők",
    stats_verifications: "Megerősítések",
    stats_reports: "Helyi jelentések",
    stats_translations: "Fordítások",
    stats_flags: "Bizonyítékok",
